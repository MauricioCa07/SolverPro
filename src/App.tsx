  ...
  return (
    <div>
      ...
      <div>
        ...
        <button onClick={() => setSelectedMethod("NewtonDivided")}>
          Newton's Divided Differences
        </button>
        <button onClick={() => setSelectedMethod("Simpson")}>
          Composite Simpson's 1/3 Rule
        </button>
        <button onClick={() => setSelectedMethod("Secant")}>
          Secant Method
        </button>
        <button onClick={() => setSelectedMethod("Gaussian")}>
          Gaussian Elimination
        </button>
        <button onClick={() => setSelectedMethod("MultipleRoots")}>
          Multiple Roots
        </button>
        ...
        <button onClick={() => setSelectedMethod("LUparcial")}>
          Partial-pivoting LU
        </button>
        <button onClick={() => setSelectedMethod("Crout")}>Crout</button>
        <button onClick={() => setSelectedMethod("GaussSeidel")}>
          Gauss-Seidel
        </button>
